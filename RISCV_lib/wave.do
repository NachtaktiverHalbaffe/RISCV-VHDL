...
add wave -noupdate -expand -group {EX Signale} -group ALU /riscv_tb/U_0/alu_out
...
add wave -noupdate -expand -group {EX Signale} -expand -group BPU /riscv_tb/U_0/ex_sbta_valid
...
add wave -noupdate -expand -group {ME Signale} -expand -group Memory /riscv_tb/U_0/ex_mem_mode
add wave -noupdate -expand -group {ME Signale} -expand -group Memory /riscv_tb/U_0/me_mem_mode
add wave -noupdate -expand -group {ME Signale} -expand -group Memory /riscv_tb/U_0/U_12/me_store_data_fwd
add wave -noupdate -expand -group {ME Signale} -expand -group Memory /riscv_tb/U_0/ex_alu_out
add wave -noupdate -expand -group {ME Signale} -expand -group Memory /riscv_tb/U_0/U_12/memory_file
...
WaveRestoreCursors {{Cursor 1} {396 ns} 0}
