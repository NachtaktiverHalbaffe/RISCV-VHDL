...
ARCHITECTURE struct OF riscv IS
   ...
   SIGNAL dec_target_reg  : std_logic_vector(4 DOWNTO 0);
   ...
   SIGNAL me_alu_out      : std_logic_vector(WORD_WIDTH-1 DOWNTO 0);
   ...
   PORT (
      ...
      dec_target_reg  : IN     std_logic_vector (4 DOWNTO 0);
      res_n           : IN     std_logic ;
   ...
   PORT (
      ...
      dec_target_reg  : OUT    std_logic_vector (4 DOWNTO 0);
   ...
   PORT (
      ...
      res_n         : IN     std_logic ;
      me_alu_out    : OUT    std_logic_vector (WORD_WIDTH-1 DOWNTO 0);
