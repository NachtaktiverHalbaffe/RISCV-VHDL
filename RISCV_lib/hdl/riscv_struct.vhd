...
ARCHITECTURE struct OF riscv IS
   ...
   SIGNAL dec_mux_memory     : std_logic;
   SIGNAL dec_next_PC        : word;
   SIGNAL dec_rs1            : word;
   SIGNAL dec_rs2            : word;
   SIGNAL dec_sbta_valid     : std_logic;
   SIGNAL dec_stba_valid     : std_logic;
   ...
   SIGNAL if_im_out          : std_logic_vector(WORD_WIDTH-1 DOWNTO 0);
   ...
   SIGNAL mux_bpu_ra_select  : std_logic;
   SIGNAL next_PC            : word;
   SIGNAL op_code            : word;
   SIGNAL pc                 : word;
   ...
   PORT (
      if_pc     : IN     word ;
      res_n     : IN     std_logic ;
      if_im_out : OUT    std_logic_vector (WORD_WIDTH-1 DOWNTO 0)
   );
   END COMPONENT;
   COMPONENT me_reg
   PORT (
   ...
   END COMPONENT;
   COMPONENT mux_bpu_ra
   PORT (
      alu_out           : IN     word ;
      ex_jmp_target     : IN     word ;
      mux_bpu_ra_select : IN     std_logic ;
      ex_alu_out        : OUT    word 
   );
   END COMPONENT;
   ...
   FOR ALL : mux_bpu_ra USE ENTITY RISCV_lib.mux_bpu_ra;
...
BEGIN
   ...
   U_18 : DBPU
      PORT MAP (
         ...
         mux_bpu_ra_select => mux_bpu_ra_select
      );
   U_9 : Imm_Gen
      PORT MAP (
