...
ARCHITECTURE struct OF riscv IS
   ...
   SIGNAL ex_alu_mode     : std_logic_vector(WORD_WIDTH-1 DOWNTO 0);
   ...
   SIGNAL sig0            : std_logic_vector(WORD_WIDTH-1 DOWNTO 0);
   ...
   PORT (
      ...
      ex_alu_mode : IN     std_logic_vector (WORD_WIDTH-1 DOWNTO 0);
