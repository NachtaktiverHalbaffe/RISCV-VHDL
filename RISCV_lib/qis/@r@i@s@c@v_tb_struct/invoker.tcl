...
if {[is_project_open]} {
   if {[string compare $quartus(project) "RISCV_tb"]} {
      puts "Project RISCV_tb is not open"
      set make_assignments 0
   }
} else {
   # Only open if not already open
   if {[project_exists RISCV_tb]} {
      project_open -revision RISCV_tb RISCV_tb
   } else {
      project_new -revision RISCV_tb RISCV_tb
   }
...
# Make assignments
if {$make_assignments} {
   set_global_assignment -name COMPILER_SETTINGS RISCV_tb
   set_global_assignment -name SIMULATOR_SETTINGS RISCV_tb
   set_global_assignment -name SOFTWARE_SETTINGS RISCV_tb
   set_global_assignment -name FMAX_REQUIREMENT 50MHz
   set_global_assignment -name FAMILY "cyclone v"
   set_global_assignment -name TOP_LEVEL_ENTITY RISCV_tb
   set_global_assignment -name DEVICE 5cgxfc5c6f27c7
   set_global_assignment -name USE_COMPILER_SETTINGS RISCV_tb
	set_global_assignment -name VHDL_FILE "/u/home/stud/flxbrggr/dev/HDS/RISCV/RISCV_lib/hdl/riscv_tb_entity.vhd" 
	...
	set_global_assignment -name VHDL_FILE "/u/home/stud/flxbrggr/dev/HDS/RISCV/RISCV_lib/hdl/clk_res_gen_entity.vhd" 
	set_global_assignment -name VHDL_FILE "/u/home/stud/flxbrggr/dev/HDS/RISCV/RISCV_lib/hdl/clk_res_gen_behav.vhd" 
	set_global_assignment -name VHDL_FILE "/u/home/stud/flxbrggr/dev/HDS/RISCV/RISCV_lib/hdl/riscv_tb_struct.vhd" 
